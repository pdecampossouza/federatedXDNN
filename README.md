...
```bash
python fed_xdnn.py --mode federated   --clients_root data/clients   --rounds 5 --local_epochs 1 --batch_size 32 --lr 3e-4   --model resnet18 --image_size 224 --fedprox_mu 0.0   --save_encoder encoder_global.pt
```
...
```bash
python fed_xdnn.py --mode local_xdnn   --clients_root data/clients --client_id siteA   --encoder_path encoder_global.pt   --batch_size 32 --image_size 224
```
...
```bash
python analyze_prototypes_shap.py   --clients_root data/clients --client_id siteA   --encoder_path encoder_global.pt --xdnn_path siteA_xdnn.pkl   --split val --per_class 1 --top_per_proto 1 --image_size 224   --out_dir shap_siteA --alpha 0.35 --sigma 0.8 --cmap seismic
```
